...
const About = () => {
    return (
        <div className='section-shell'>
            ...
            <div className='surface-card mx-auto my-6 flex max-w-5xl flex-col gap-6 p-6 md:flex-row'>
                <div className='flex flex-1 flex-col items-center justify-center' data-aos="fade-right" data-aos-duration="1000">
                    <img src={instructorPhoto} alt="" className='max-w-[350px] rounded-bl-3xl rounded-tr-3xl shadow-lg' />
